...
typedef enum {
    OBJ_BOUND_METHOD,   // GC Type : 0
    OBJ_CLASS,          // GC Type : 1
    OBJ_CLOSURE,        // GC Type : 2
    OBJ_FUNCTION,       // GC Type : 3
    OBJ_INSTANCE,       // GC Type : 4
    OBJ_NATIVE,         // GC Type : 5
    OBJ_STRING,         // GC Type : 6
    OBJ_UPVALUE         // GC Type : 7
} ObjType;
